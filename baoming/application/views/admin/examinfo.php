    ...
    var vm =new Vue({
        ...
        methods:{
            ...
            yes:function () {
                $('#myModal3').modal('hide');
                //获取前一页传过来的科目名
                var sname="<?php echo $_GET['s_name'] ;?>";
                //以科目名为参数到控制台admin下的exam_updatey方法
                $.post('admin/exam_updatey',{id:this.id,sname:sname,state:1,cid:this.cid},function (res) {
                        if(res ==1){
                            alert('审核成功');
            ...
            no:function () {
                $('#myModal3').modal('hide');
                var sname="<?php echo $_GET['s_name'] ;?>";
                //以科目名为参数到控制台admin下的exam_update方法
                $.post('admin/exam_update',{id:this.id,sname:sname,state:0},function (res) {
                        if(res ==1){
                            alert('审核成功');
                            location='admin/personal';
                        }else {
